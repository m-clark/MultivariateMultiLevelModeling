# Data generating function for a multivariate 2-level HLM with factor structure at level 2 (hmlm2fs)
...
# source(file = "code//fun_simple_lambda.R") 
# (Lambda <- simpleLambda(nunk=c(2,1), lambda=c(.9,.7,.5)))
# debugonce(hmlm2fs_datGen)
# hmlm2fs_dat <- hmlm2fs_datGen(S=5, L=2, n=10, J=40, 
