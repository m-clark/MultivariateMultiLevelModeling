...
One might notice that even though the Tau matrix was diagonal, correlations were estimated that were not zero.  This is spurious due to the fact that we had only 10 correlations.
...
ranefs = sapply(schoolWideTest[,c('1','2','3')], function(y) ranef(lmer(y~1|J, data=schoolWideTest))$J$'(Intercept)')
cor(ranefs)
```
